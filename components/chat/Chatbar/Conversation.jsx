  ...
  return (
    <div className="relative flex items-center">
      {isRenaming && selectedConversation.id === conversation.id ? (
        ...
        <button
          className={`flex w-full cursor-pointer items-center gap-3 rounded-lg p-3 text-sm transition-colors duration-200 hover:bg-indigo-600 ${
            loading ? 'disabled:cursor-not-allowed' : ''
          } ${
            selectedConversation.id === conversation.id ? 'bg-indigo-600' : ''
          }`}
