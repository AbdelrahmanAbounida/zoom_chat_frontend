import { DEFAULT_SYSTEM_PROMPT } from '@/chat_utils/const/openai';
import { ZoomOpenAIError, ZoomOpenAIStream } from '@/chat_utils/zoom';
...
const handler = async (req) => {
  try {
    ...
    console.error(error);
    if (error instanceof ZoomOpenAIError) {
