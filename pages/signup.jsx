...
const Signup = () => {
    ...
    const handleRegister = async (e)=>{
        ...
        if(!confirmPasswordRef.current.value){
          return seterror("confirm Password shouldn't be none")
        }
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden dark:bg-black bg-white">
          ...
          <section class="bg-gray-50 dark:bg-gray-900 mt-5">
              ...
              { error &&
                          <div className="max-w-2xl mx-auto bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-1" role="alert">
            ...
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                ...
                <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8 justify-items-center flex-auto">
                        ...
                        <button onClick={handleGoogleRegister} class="bg-white hover:bg-gray-100 text-gray-700 border inline-flex items-center font-medium rounded-lg text-md px-5 py-2.5 text-center w-full border-gray-300">
                        ...
                        <form class="space-y-4 md:space-y-6" action="/chat" onSubmit={handleRegister}>
                            <div>
                            ...
                            <div>
                                ...
                                <input ref={confirmPasswordRef} type="password" name="confirmpassword" id="confirm_password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="" />
                            </div>
                            ...
                            {loading ? 
                              ...
                              :
                            <button type="submit" class="w-full text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Signup</button>
                            }
                  
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                              Already have an account? <Link href="/login" class="font-medium text-indigo-600 hover:underline dark:text-indigo-500">Login</Link>
                            </p>
                        </form>
                    </div>
                </div>
